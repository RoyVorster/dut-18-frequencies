function [rpOut, time_step] = sample_road_profile(k, sim_time, V, plotOn)
...
rp.k = k; % Values For ISO Road A-B Roughness Classification, from 3 to 9
rp.L = sim_time * V; % Length Of Road Profile (m)
rp.B  = 0.01; % Sampling Interval (m)
